                ...
                <div class="account-footer">
                    <div class="grid wide">
                        <div class="row">
                            ...
                            <div class="col l-2-4 c-12 m-6">
                                <div class="account-footer_titel">VỀ MLL</div>
                                <div class="account-footer_list">
                                 <ul>
                                     <li>
                                         <a href="">Giới thiệu về MLL</a>
                                     </li>
                                     <li>
                                         <a href="">Tuyển dụng</a>
                                     </li>
                                     <li>
                                         <a href="">Điều khoản MLL</a>
                                     </li>
                                     <li>
                            ...
                            <div class="col c-12 l-2-4 m-6">
                                <div class="account-footer_titel">TẢI ỨNG DỤNG MLL NGAY THÔI</div>
                                <div class="account-footer_list">
                                 <ul>
                                     <li>
